...
def rec(u,pra,ite,wa,wb):  
    ...
    for i in range(20):
        ...
        print('I recommend ' + str( df_movies.iloc[np.argsort(-rec)[i], 0]) + ':' + str( df_movies.iloc[np.argsort(-rec)[i], 1]) + 'to ' + str(t_u + 1))
    ...
    print('u: ' + str(round(ex_u  * 100,3)), 'm: ' + str(round(ex_m  * 100,3)), 't: ' + str(round(ex_t  * 100,3)) )
