def rec(pra,ite,n):  
    ...
    with open('movielen_000_inf.csv','w') as f:
    ...
    for train, test in kf.split(dR):
        ...
        for i in range(lr):
            ...
            v_c1[train_df.at[i,'userId'] - 1] += W[i,i]
            v_c1[lu + train_df.at[i,'movieid']] += W[i,i] 
            a1[train_df.at[i,'userId'] - 1, train_df.at[i,'userId'] - 1] += (W[i,i] / 2)
            a1[train_df.at[i,'userId'] - 1, lu + train_df.at[i,'movieid']] += (W[i,i] / 2)
            a1[lu + train_df.at[i,'movieid'], train_df.at[i,'userId'] - 1] += (W[i,i] / 2)
            a1[lu + train_df.at[i,'movieid'] , lu + train_df.at[i,'movieid']] += (W[i,i] / 2)
    ...
    for u in range(lu):
        with open('movielen_000_inf.csv','a') as f:
            writer = csv.writer(f,lineterminator='\n')
